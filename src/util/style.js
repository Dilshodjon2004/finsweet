export const styles = {
  container: "xl:max-w-[1280px] w-full sm:px-16 px-6",
  ...
  btnContact:
    "bg-transparent px-[48px] py-[16px] rounded-[40px] text-[16px] border-2 border-solid border-[rgba(244, 246, 252, 0.20)] font-normal text-btnTextColorPrimary",
};
